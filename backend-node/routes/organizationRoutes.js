...
import { registerOrganization, loginOrganization, getOrganizations, getInstitutions, getStudents, getOrganizationProfile } from '../controllers/organizationController.js';
...
router.get('/me', authMiddleware, getOrganizationProfile);
